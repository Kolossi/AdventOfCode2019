...
namespace Runner
{
    public class IntcodeV2
    {
        ...
        public IntcodeV2(long initialInput, long[] data)
        {
            Data = CloneData(data);
        ...
        public class OpDef
        {
            ...
            public Func<IntcodeV2, long[], Parameter[], long[]> Function;
            ...
            public static long[] Add(IntcodeV2 intcode, long[] data, Parameter[] parameters)
            {
            ...
            public static long[] Multiply(IntcodeV2 intcode, long[] data, Parameter[] parameters)
            {
                long result = parameters[0].GetValue(intcode) * parameters[1].GetValue(intcode);
                intcode.Store(data, result, parameters[2]);
                return data;
            ...
            public static long[] StoreInput(IntcodeV2 intcode, long[] data, Parameter[] parameters)
            {
            ...
            public static long[] Output(IntcodeV2 intcode, long[] data, Parameter[] parameters)
            {
                intcode.OutputQueue.Enqueue(parameters[0].GetValue(intcode));
                return data;
            }

            public static long[] Halt(IntcodeV2 intcode, long[] data, Parameter[] parameters)
            {
                intcode.Halt = true;
                return data;
            }

            public static long[] JumpIfTrue(IntcodeV2 intcode, long[] data, Parameter[] parameters)
            {
            ...
            public static long[] JumpIfFalse(IntcodeV2 intcode, long[] data, Parameter[] parameters)
            {
                if (parameters[0].GetValue(intcode) == 0)
                {
                    intcode.Ptr = parameters[1].GetValue(intcode);
            ...
            public static long[] LessThan(IntcodeV2 intcode, long[] data, Parameter[] parameters)
            {
                intcode.Store(data,
            ...
            public static long[] Equals(IntcodeV2 intcode, long[] data, Parameter[] parameters)
            {
                intcode.Store(data,
                    (parameters[0].GetValue(intcode) == parameters[1].GetValue(intcode)) ? 1 : 0,
                    parameters[2]);
            ...
            public static long[] AdjustRelativeOffset(IntcodeV2 intcode, long[] data, Parameter[] parameters)
            {
